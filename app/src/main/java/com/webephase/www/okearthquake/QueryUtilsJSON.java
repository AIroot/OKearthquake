...
public final class QueryUtilsJSON {
     ...
     */
    private QueryUtilsJSON() {
    }

    /**
     * Return a list of {@link OkEarthquake} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<OkEarthquake> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<OkEarthquake> earthquakes = new ArrayList<>();
...
//            Add earthquake to list of earthquakes
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                OkEarthquake earthquake = new OkEarthquake(magnitude, location, time);
